...
if ($res->num_rows > 0)
{
	while ($row = $res->fetch_assoc())
	{
        ...
        $html .= '<td><a class="action" href="?action=delete&id=' . $row ['id'] . '" title="usuń"  onclick=
        "return doAlert("Czy na pewno chcesz usunąć ?");"><i class="fa fa-times text-danger"></i>usuń</a></td>';
        $html .= '</tr>';
	}
    $html .= "</tbody>";
    $html .= "</table>";
